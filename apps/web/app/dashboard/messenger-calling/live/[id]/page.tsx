...
import { ArrowLeft, Headphones, MessageCircle, Sparkles } from 'lucide-react';
 ...
 * pulses to the conversation while the call is live and everything else stays still (restraint rule §4).
 * Surfaces who's calling (PSID), the m.me `ref` context ("why they're calling"), the answering agent, a
 * talk/listen indicator, and a status timeline, with a one-tap "take over" into the Agent Desk. Polls the
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            {/* Why they're calling — decoded from the m.me ref (real context). */}
            <Card>
...
function contextRows(ctx: MessengerCallContext): { label: string; value: string }[] {
