...
const NAV = [
  ...
  { href: '/dashboard/copilot', label: 'Live Co-Pilot', icon: Swords, exact: false },
  { href: '/dashboard/settings/translation', label: 'Translation', icon: Languages, exact: false },
  { href: '/dashboard/sentiment', label: 'Live sentiment', icon: Activity, exact: false },
  { href: '/dashboard/analytics', label: 'Analytics', icon: BarChart3, exact: false },
  { href: '/dashboard/benchmarking', label: 'Benchmarking', icon: Trophy, exact: false },
  { href: '/dashboard/exports', label: 'BI exports', icon: Database, exact: false },
  ...
  { href: '/dashboard/voice-emotion', label: 'Voice emotion', icon: Smile, exact: false },
  { href: '/dashboard/avatars', label: 'Video avatars', icon: UserSquare2, exact: false },
  { href: '/dashboard/models', label: 'Custom models', icon: BrainCircuit, exact: false },
  ...
  { href: '/dashboard/callbacks', label: 'Callbacks', icon: PhoneOutgoing, exact: false },
  ...
  {
    href: '/dashboard/settings/biometrics',
